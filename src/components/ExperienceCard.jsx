...
const ExperienceCard = ({
  ...
  return (
    <a href={link} target='_blank' rel='noopener noreferrer' className={`block ${className}`}>
      <div className='p-6 shadow-xl hover:bg-primary hover:shadow-xl hover:rounded-lg transition-all duration-300 max-w-3xl mb-6'>
        <div className='flex justify-between items-center mb-4'>
          ...
          <div className='flex items-center'>
            ...
            <FiExternalLink size={20} className='ml-2 text-secondary' />
          </div>
        </div>
