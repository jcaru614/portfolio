...
const ProjectCard = ({ title, description, images, skills, link, imageSize, github }) => {
  ...
  return (
    <a href={link} target='_blank' rel='noopener noreferrer' className='block'>
      <div className='w-full flex flex-col items-start gap-4 p-6 rounded-lg shadow-xl bg-background hover:bg-primary hover:shadow-2xl transition-all duration-300'>
